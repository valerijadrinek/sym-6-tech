 ...
 */
final class Version20231116111351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE vinyl_songs_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE vinyl_songs (id INT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE vinyl_songs_id_seq CASCADE');
        $this->addSql('DROP TABLE vinyl_mix');
        $this->addSql('DROP TABLE vinyl_songs');
